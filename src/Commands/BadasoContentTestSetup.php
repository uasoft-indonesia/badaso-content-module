...
class BadasoContentTestSetup extends Command
{
    public static $PHPUNIT_XML_PATH = 'phpunit.xml';
    public static $BADASO_UNIT_TEST_PATHS = [
        './vendor/badaso/content-module/tests/Unit',
    ];
    public static $BADASO_FEATURE_TEST_PATHS = [
        './vendor/badaso/content-module/tests/Feature',
    ];
     ...
     * @var string
     */
    protected $signature = 'badaso-content-test:setup';
